...
export default function App() {
  ...
  // デザインテーマ: 現行(modern) を既定とし、TENTIAL 版を別バージョンとして切替可能にする
  const [theme, setTheme] = useState<"modern" | "tential">(() => {
    try {
      return localStorage.getItem("ctn.theme") === "tential" ? "tential" : "modern";
    } catch {
      return "modern";
    }
  });
