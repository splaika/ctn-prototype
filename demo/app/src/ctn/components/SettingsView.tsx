      ...
      <div style={{ maxWidth: 760 }}>
        ...
        <Section title={t("Enable / disable checks", "チェックの有効化")}>
          <div className="rule-toggles">
            ...
            <label className="rule-toggle"><input type="checkbox" checked={v.submitReminder} disabled={!canEdit} onChange={bool("submitReminder")} /><div><b>{t("Awaiting-submission reminder", "提出待ちリマインダ")}</b><span>{t("Remind when filings in review are not yet submitted.", "レビュー中で未提出の届をリマインド。")}</span></div></label>
